...
const AiHelper: React.FC<AiHelperProps> = ({ rpgData }) => {
  const [prompt, setPrompt] = useState('');
  const { generate, loading, error, response } = useAiApi();
  ...
  return (
    <div className="space-y-4 text-gray-200">
      <h3 className="text-xl font-semibold text-white">AI Game Helper</h3>
